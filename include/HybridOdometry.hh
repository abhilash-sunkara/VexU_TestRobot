 ...
 *
 */
class HybridOdometry : public Odometry, public AsyncRunnable {
 public:
  /**
  ...
  HybridOdometry(pros::Rotation ilongitudinal_sensor,
 ...
 private:
  ...
  bool updated_pos_avalable = false;
  OdometryState updated_position{{0_in, 0_in, 0_deg},
                                 {0_mps, 0_mps, 0_deg / second}};
